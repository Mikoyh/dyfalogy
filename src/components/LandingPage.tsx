...
export const LandingPage = memo(({ onLogin, onPortfolioClick }: { onLogin: () => void, onPortfolioClick: () => void }) => {
  return (
    <div className="min-h-screen bg-bg relative overflow-hidden flex flex-col p-6 bg-gradient-to-b from-bg to-accent/5">
      ...
      {/* Creative Footer - Changed to mt-auto for flow separation */}
      <motion.footer 
        initial={{ opacity: 0 }}
        animate={{ opacity: 0.6 }}
        className="mt-auto pt-16 pb-8 relative z-20 flex flex-col items-center gap-2 group cursor-default"
      >
